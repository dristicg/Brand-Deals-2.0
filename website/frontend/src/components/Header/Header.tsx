...
export default async function Header() {
  ...
  if (isLoggedIn) {
    ...
    if (cartRes && cartRes.success && cartRes.data.cart) {
      initialCount = cartRes.data.cart.items.reduce((acc: number, item: any) => acc + item.quantity, 0);
    }
  }
      ...
      <div className={styles.headerInner}>
        ...
        <div className={styles.actions}>
          ...
          <Link href="/cart" className={styles.iconBtn} aria-label="Shopping cart">
            ...
            <CartBadge initialCount={initialCount} />
          </Link>
